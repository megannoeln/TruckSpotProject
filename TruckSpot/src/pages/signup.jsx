...
const SignUpForm = () => {
  ...
  return <div className="font-[sans-serif] bg-white md:h-screen">
        ...
        <form onSubmit={handleSubmit} class="max-w-lg w-full mx-auto">
          ...
          <div>
            ...
            <div class="relative flex items-center">
              <input name="firstname" type="text" onChange={handleInput}  class="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter first name" />
            </div>
          ...
          <div class="mt-8">
            ...
            <div class="relative flex items-center">
              <input name="lastname" type="text" onChange={handleInput}  class="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter last name" />             
            </div>
          ...
          <div class="mt-8">
            ...
            <div class="relative flex items-center">
              <input name="phone" type="text" onChange={handleInput}  class="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter phone number" />
            </div>
          ...
          <div class="mt-8">
            ...
            <div class="relative flex items-center">
              <input name="email" type="text" onChange={handleInput}  class="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter email" />             
            </div>
          ...
          <div class="mt-8">
            ...
            <div class="relative flex items-center">
              <input name="password" type="password" onChange={handleInput}  class="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter password" />
            </div>
